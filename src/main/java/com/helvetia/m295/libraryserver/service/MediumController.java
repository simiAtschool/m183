...
public class MediumController {
     ...
     */
    @PostMapping("")
    public @ResponseBody Medium addMedium(@Valid @RequestBody Medium data) {
     ...
     */
    @PutMapping("/{id}")
    public @ResponseBody Medium updateMedium(@Valid @RequestBody Medium data, @PathVariable Long id) {
