...
/**
 * Klasse, um HTTP-Anfragen der Methode "PUT" auszuführen <br>
 ...
 * @author Simon Fäs
 */
public class RestPutRequest<T extends BaseItem> extends AsyncTask<String, Integer, String> {
     ...
     */
    public RestPutRequest(AsyncFormListener<T> listener, T object) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            // Verbindung aufbauen
            URL url = new URL(SingletonAppData.getInstance().getApiURL() + "/" + (object instanceof Medium ? "medium/" : "ausleihe/") + object.getId().toString());
